---
title: "Operations with Spatial Data in R -- Raster Data"
output:
  html_document:
    toc: true
    toc_depth: 4
...
Before we start, please make sure you have the `raster` and `dplyr` installed. 

# 1. Re-projecting Raster Data

In order to reproject a raster, we will want to use the `projectRaster()` command from the `raster` package.

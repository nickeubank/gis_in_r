...
## 2. Creating a SpatialPoints object from scratch
...
### 2.2 Coordinate Reference System: what makes SpatialPoints spatial
...
### 2.4 Creating a SpatialPoint Object from a lat/lon table
...
## 3 Creating Spatial Polygons

### 3.1 Building up Polygons
...
### 3.2 Projections
Projections work the same way for `SpatialPolygons` as for `SpatialPoints`.
...
### 3.3 Adding Attributes to SpatialPolygon
...
## 4. Getting spatial data in and out of R 

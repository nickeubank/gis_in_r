...
projection(dots.all) <- CRS(proj4string(palo_alto))
...
I cannot, for the life of me, figure out how to plot **accurate** basemaps with spplot. [There are methods that will place approximate basemaps under your spplots](http://www.r-bloggers.com/stamen-maps-with-spplot/), but these methods treat the basemaps as being in a WGS84 projection, which they are not -- the maps they query are in WGS84 Web Mercator, which is similar but different. [As a result, the outputs are not terrible, but are definitely **wrong**, as discussed in more detail here.](http://rstudio-pubs-static.s3.amazonaws.com/16660_7d1ab1b355344578bbacb0747fd485c8.html)

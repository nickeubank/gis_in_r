...
# 4. A final note on ggplot and ggmap
...
A big advantage to using `ggplot` for mapping is the `ggmap` library, which allows you to add basemaps from internet sources. 
